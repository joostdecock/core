...
class BennoBoxerBriefs extends Pattern
{
    ...
    public function loadHelp($model)
    {
        ...
        if($this->o('verticalStretchFactor')<0.5) $this->setOption('verticalStretchFactor', 0.5);
        if($this->o('horizontalStretchFactor')<0.5) $this->setOption('horizontalStretchFactor', 0.5);
    }
